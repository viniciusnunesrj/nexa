...
export const Arena: React.FC<ArenaProps> = ({ onNavigate }) => {
  ...
  const submitPvpMove = async () => {
    ...
    setPvpSubmitting(true); setPvpRoundResult(null); setPvpStatus('Jogada enviada. Aguardando adversário...');
