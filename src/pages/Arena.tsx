...
export const Arena: React.FC<ArenaProps> = ({ onNavigate }) => {
  ...
  const pvpRoundHistory = pvpHistory.filter((item) => Number(item.round) < pvpServerRound);
