...
{pvpRoundHistory.length>0&&<div className="mt-3 flex justify-center gap-2">{pvpRoundHistory.map(item=><span key={item.round} className="rounded-full border border-white/10 px-2 py-1 text-[8px] font-black text-slate-400">R{item.round} · CONCLUÍDA</span>)}</div>}
