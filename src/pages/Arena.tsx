  ...
  return (
    <>
      ...
      @supports (-webkit-touch-callout: none) {
        @media (orientation: landscape) and (max-width: 1100px) {
          .duel-canvas .duel-layout { grid-template-rows:9% minmax(0,37%) 7% minmax(0,37%) 10%!important; }
          .duel-canvas .duel-row { min-width:0!important; min-height:0!important; overflow:visible!important; }
          .duel-canvas .duel-slot { height:min(88%,31dvh)!important; max-height:100%!important; min-width:0!important; }
        }
      }
