...
export const Arena: React.FC<ArenaProps> = ({ onNavigate }) => {
  ...
  .pvp-reveal-stage{animation:pvp-stage-in .35s ease-out both}.pvp-reveal-card{padding:.75rem;border:1px solid #ffffff18;border-radius:.7rem;background:#ffffff08;animation:pvp-card-enter .55s cubic-bezier(.2,.8,.2,1) both}.pvp-host{transform-origin:right center}.pvp-guest{transform-origin:left center;animation-name:pvp-card-enter-right}.pvp-vs{animation:pvp-vs-pop .7s .35s ease-out both}.pvp-impact{animation:pvp-impact-in .45s 1.05s ease-out both}@keyframes pvp-stage-in{from{opacity:0}to{opacity:1}}@keyframes pvp-card-enter{from{opacity:0;transform:translateX(-45%) scale(.8)}to{opacity:1;transform:none}}@keyframes pvp-card-enter-right{from{opacity:0;transform:translateX(45%) scale(.8)}to{opacity:1;transform:none}}@keyframes pvp-vs-pop{0%{opacity:0;transform:scale(.2)}65%{opacity:1;transform:scale(1.3)}100%{transform:scale(1)}}@keyframes pvp-impact-in{from{opacity:0;transform:scale(.7)}to{opacity:1;transform:scale(1)}}\n  @keyframes pvp-wait-pulse{0%,100%{opacity:.35;box-shadow:0 0 0 0 #c084fc55}50%{opacity:1;box-shadow:0 0 0 .45rem #c084fc00}} .pvp-wait-dot{animation:pvp-wait-pulse 1.1s ease-in-out infinite}\n  @media (max-width:640px){ .arena-lobby{gap:1rem}.arena-card-grid{gap:.55rem}.arena-start{bottom:.5rem} }
`}</style></div>;
};
