...
export const Arena: React.FC<ArenaProps> = ({ onNavigate }) => {
  ...
  const playPvpReveal = (result: any, resolvedRound: number, resetChoice = true) => {
    ...
    pvpRevealTimers.current.push(window.setTimeout(() => { setPvpReveal(false); setPvpRevealStep(0); if (resetChoice) { setPvpCardId(null); setPvpNexos(0); } }, 4200));
  };
