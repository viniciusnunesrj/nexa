    ...
    <div className="space-y-4">
      ...
      <div className="grid items-stretch gap-3 lg:grid-cols-3">
        ...
        <button onClick={()=>onNavigate('collections')} className="group h-[190px] overflow-hidden rounded-[14px] border border-fuchsia-400/30 bg-[#110817] p-3.5 text-left shadow-[0_0_24px_rgba(217,70,239,.07)]">
          ...
          <div onClick={(e)=>{e.stopPropagation();onNavigate('boxes')}} className="mt-1.5 flex h-7 w-full items-center justify-center gap-2 rounded-md border border-fuchsia-400/35 bg-fuchsia-500/[.10] font-heading text-[8px] font-black uppercase tracking-[.08em] text-fuchsia-200 shadow-[0_0_14px_rgba(217,70,239,.10)] transition hover:bg-fuchsia-500/[.18]"><PackageOpen className="h-3 w-3"/> Ver minhas caixas <ChevronRight className="h-3 w-3"/></div>
        </button>
