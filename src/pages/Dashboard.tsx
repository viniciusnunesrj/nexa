    ...
    <div className="space-y-4">
      ...
      <section className="relative isolate overflow-hidden rounded-[22px] border border-cyan-400/25 bg-[#040811] shadow-[0_30px_100px_rgba(0,0,0,.52),0_0_45px_rgba(34,211,238,.06)]">
        ...
        <div className="relative min-h-[390px] px-4 py-5 sm:min-h-[345px] sm:px-7 lg:h-[344px] lg:min-h-0 lg:px-8">
          ...
          <div className="absolute inset-x-4 bottom-3 z-20 grid grid-cols-3 overflow-hidden rounded-xl border border-cyan-300/20 bg-[#06101b]/95 backdrop-blur-md sm:inset-x-7 sm:grid-cols-5 lg:left-[7%] lg:right-[7%]">
            ...
            <div className="hidden min-h-[58px] items-center gap-2 border-r border-white/[.07] px-2 sm:flex lg:gap-3 lg:px-4"><Trophy className="h-5 w-5 text-amber-300"/><div><p className="font-heading text-base font-black text-white">{user.victories}</p><p className="text-[8px] font-medium text-slate-300">Vitórias totais</p></div></div>
            <div className="hidden min-h-[58px] items-center gap-2 px-2 sm:flex lg:gap-3 lg:px-4"><Swords className="h-5 w-5 text-violet-300"/><div><p className="font-heading text-base font-black text-white">{user.victories + user.defeats}</p><p className="text-[8px] font-medium text-slate-300">Batalhas registradas</p></div></div>
          </div>
        </div>
      </section>
