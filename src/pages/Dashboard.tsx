    ...
    <div className="space-y-4">
      ...
      <section className="relative isolate overflow-hidden rounded-[22px] border border-cyan-400/25 bg-[#040811] shadow-[0_30px_100px_rgba(0,0,0,.52),0_0_45px_rgba(34,211,238,.06)]">
        ...
        <div className="relative min-h-[390px] px-4 py-5 sm:min-h-[345px] sm:px-7 lg:min-h-[338px] lg:px-8">
          ...
          <div className="absolute inset-x-4 bottom-3 z-20 grid grid-cols-3 overflow-hidden rounded-[11px] border border-cyan-300/20 bg-[#06101b]/95 shadow-[0_0_32px_rgba(34,211,238,.08),0_12px_35px_rgba(0,0,0,.38)] backdrop-blur-md sm:inset-x-7 lg:left-[7%] lg:right-[7%] lg:grid-cols-5">
            <div className="flex min-h-[58px] items-center gap-3 border-r border-white/[.07] px-4"><span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-cyan-400/25 bg-cyan-400/[.08] text-cyan-300"><Layers className="h-[18px] w-[18px]"/></span><div><p className="font-heading text-[17px] font-black leading-none text-white">{userCards.length}</p><p className="mt-1 text-[8px] text-slate-400">Cartas no inventário</p></div></div>
            <div className="flex min-h-[58px] items-center gap-3 border-r border-white/[.07] px-4"><span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-sky-400/25 bg-sky-400/[.08] text-sky-300"><Award className="h-[18px] w-[18px]"/></span><div><p className="font-heading text-[17px] font-black leading-none text-white">Nv. {currentLevel}</p><p className="mt-1 text-[8px] text-cyan-400">Piloto</p></div></div>
            <div className="flex min-h-[58px] items-center gap-3 border-r border-white/[.07] px-4"><span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md border border-cyan-400/20 bg-cyan-400/[.06] text-[8px] font-black text-cyan-300">XP</span><div className="min-w-0 flex-1"><div className="flex items-baseline gap-1"><p className="font-heading text-[13px] font-black text-sky-300">{currentExp}</p><span className="text-[7px] text-slate-500">/ {maxExp} XP</span></div><p className="text-[7px] text-slate-400">Para o próximo nível</p><div className="mt-1 h-1 overflow-hidden rounded-full bg-white/[.08]"><div style={{width:`${xpPercent}%`}} className="h-full rounded-full bg-gradient-to-r from-cyan-400 to-violet-400"/></div></div></div></div>
            <div className="hidden min-h-[58px] items-center gap-3 border-r border-white/[.07] px-4 lg:flex"><span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-amber-400/25 bg-amber-400/[.07] text-amber-300"><Trophy className="h-[18px] w-[18px]"/></span><div><p className="font-heading text-[17px] font-black leading-none text-white">{user.victories}</p><p className="mt-1 text-[8px] text-slate-400">Vitórias totais</p></div></div>
            <div className="hidden min-h-[58px] items-center gap-3 px-4 lg:flex"><span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-violet-400/25 bg-violet-400/[.07] text-violet-300"><Swords className="h-[18px] w-[18px]"/></span><div><p className="font-heading text-[17px] font-black leading-none text-white">{user.victories + user.defeats}</p><p className="mt-1 text-[8px] text-slate-400">Batalhas registradas</p></div></div>
          </div>
        </div>
      </section>
      ...
      <div className="grid items-stretch gap-3 lg:grid-cols-3">
        <button onClick={()=>onNavigate('progression')} className="group h-[190px] rounded-[14px] border border-cyan-400/30 bg-[#06111b] p-3.5 text-left shadow-[0_0_24px_rgba(34,211,238,.06)]">
        ...
        <button onClick={()=>onNavigate('collections')} className="group h-[190px] overflow-hidden rounded-[14px] border border-fuchsia-400/30 bg-[#110817] p-3.5 text-left shadow-[0_0_24px_rgba(217,70,239,.07)]">
          ...
          <button type="button" onClick={(e)=>{e.stopPropagation();onNavigate('boxes')}} className="mt-1.5 flex h-7 w-full items-center justify-center gap-2 rounded-md border border-fuchsia-400/35 bg-fuchsia-500/[.10] font-heading text-[8px] font-black uppercase tracking-[.08em] text-fuchsia-200 shadow-[0_0_14px_rgba(217,70,239,.10)] transition hover:bg-fuchsia-500/[.18]"><PackageOpen className="h-3 w-3"/> Ver minhas caixas <ChevronRight className="h-3 w-3"/></button>
        </button>

        <div className="h-[190px] rounded-[14px] border border-sky-400/25 bg-[#070e17] p-3.5 shadow-[0_0_24px_rgba(56,189,248,.06)]">
      ...
      <footer className="flex items-center justify-between border-t border-cyan-400/10 px-1 pt-2 font-mono text-[8px] uppercase tracking-[.12em] text-slate-500">
