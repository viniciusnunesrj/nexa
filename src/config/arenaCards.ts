...
export const ARENA_CARDS: ArenaCard[] = [
  ...
  { id: 'card-ice-guardian', name: 'Guardião do Gelo', element: 'Gelo', rarity: 'Raro', attack: 5, health: 6, energyCost: 3, power: 5, damage: 4, description: 'Guardião do Gelo.', ability: 'BLINDAGEM', abilityKind: 'BLINDAGEM' },
  { id: 'card-storm-guardian', name: 'Guardião da Tempestade', element: 'Raio', rarity: 'Épico', attack: 6, health: 6, energyCost: 3, power: 6, damage: 4, description: 'Guardião da Tempestade.', ability: 'DRENO', abilityKind: 'DRENO' },
  { id: 'card-abyss-guardian', name: 'Guardião do Abismo', element: 'Abismo', rarity: 'Lendário', attack: 7, health: 6, energyCost: 3, power: 7, damage: 5, description: 'Guardião do Abismo.', ability: 'ECO', abilityKind: 'ECO' },
  ...
  { id: 'card-dragon-frost', name: 'Dragão Glacial', element: 'Gelo', rarity: 'Raro', attack: 5, health: 6, energyCost: 3, power: 5, damage: 4, description: 'Dragão Glacial.', ability: 'BLINDAGEM', abilityKind: 'BLINDAGEM' },
  ...
  { id: 'card-dragon-astral', name: 'Dragão Astral', element: 'Astral', rarity: 'Épico', attack: 6, health: 6, energyCost: 3, power: 6, damage: 4, description: 'Dragão Astral.', ability: 'ECO', abilityKind: 'ECO' },
  ...
  { id: 'card-dragon-celestial', name: 'Dragão Celestial', element: 'Celestial', rarity: 'Mítico', attack: 8, health: 6, energyCost: 3, power: 8, damage: 4, description: 'Dragão Celestial.', ability: 'DRENO', abilityKind: 'DRENO' },
  ...
  { id: 'card-knight-lunar', name: 'Cavaleiro Lunar', element: 'Lunar', rarity: 'Épico', attack: 6, health: 6, energyCost: 3, power: 6, damage: 4, description: 'Cavaleiro Lunar.', ability: 'DRENO', abilityKind: 'DRENO' },
  ...
  { id: 'card-knight-celestial', name: 'Cavaleiro Celestial', element: 'Celestial', rarity: 'Mítico', attack: 7, health: 6, energyCost: 3, power: 7, damage: 5, description: 'Cavaleiro Celestial.', ability: 'ECO', abilityKind: 'ECO' },
  { id: 'card-abyss-devourer', name: 'Devorador', element: 'Abismo', rarity: 'Comum', attack: 3, health: 6, energyCost: 3, power: 3, damage: 3, description: 'Devorador.', ability: 'ECO', abilityKind: 'ECO', starter: true },
  { id: 'card-abyss-colossus', name: 'Colosso Abissal', element: 'Abismo', rarity: 'Incomum', attack: 4, health: 6, energyCost: 3, power: 4, damage: 3, description: 'Colosso Abissal.', ability: 'BLINDAGEM', abilityKind: 'BLINDAGEM' },
  ...
  { id: 'card-abyss-demon', name: 'Demônio do Vazio', element: 'Vazio', rarity: 'Raro', attack: 5, health: 6, energyCost: 3, power: 5, damage: 4, description: 'Demônio do Vazio.', ability: 'DRENO', abilityKind: 'DRENO' },
  ...
  { id: 'card-abyss-king', name: 'Rei do Abismo', element: 'Abismo', rarity: 'Mítico', attack: 5, health: 6, energyCost: 3, power: 5, damage: 7, description: 'Rei do Abismo.', ability: 'BLINDAGEM', abilityKind: 'BLINDAGEM' },
  ...
  { id: 'card-mage-ice', name: 'Mago do Gelo', element: 'Gelo', rarity: 'Comum', attack: 4, health: 6, energyCost: 3, power: 4, damage: 2, description: 'Mago do Gelo.', ability: 'BLINDAGEM', abilityKind: 'BLINDAGEM', starter: true },
  { id: 'card-mage-earth', name: 'Mago da Terra', element: 'Terra', rarity: 'Incomum', attack: 4, health: 6, energyCost: 3, power: 4, damage: 3, description: 'Mago da Terra.', ability: 'BLINDAGEM', abilityKind: 'BLINDAGEM' },
  { id: 'card-mage-wind', name: 'Mago do Ar', element: 'Ar', rarity: 'Incomum', attack: 5, health: 6, energyCost: 3, power: 5, damage: 3, description: 'Mago do Ar.', ability: 'ECO', abilityKind: 'ECO' },
  ...
  { id: 'card-god-moon', name: 'Deusa da Lua', element: 'Lunar', rarity: 'Raro', attack: 5, health: 6, energyCost: 3, power: 5, damage: 4, description: 'Deusa da Lua.', ability: 'DRENO', abilityKind: 'DRENO' },
  { id: 'card-god-thunder', name: 'Deus do Trovão', element: 'Raio', rarity: 'Épico', attack: 6, health: 6, energyCost: 3, power: 6, damage: 4, description: 'Deus do Trovão.', ability: 'IMPULSO', abilityKind: 'IMPULSO' },
  ...
  { id: 'card-god-chaos', name: 'Deus do Caos', element: 'Vazio', rarity: 'Lendário', attack: 6, health: 6, energyCost: 3, power: 6, damage: 6, description: 'Deus do Caos.', ability: 'IMPULSO', abilityKind: 'IMPULSO' },
  { id: 'card-god-supreme', name: 'Deus Supremo', element: 'Celestial', rarity: 'Mítico', attack: 8, health: 6, energyCost: 3, power: 8, damage: 5, description: 'Deus Supremo.', ability: 'BLINDAGEM', abilityKind: 'BLINDAGEM' },
  { id: 'card-cosmic-guardian', name: 'Guardião Estelar', element: 'Cósmico', rarity: 'Incomum', attack: 4, health: 6, energyCost: 3, power: 4, damage: 3, description: 'Guardião Estelar.', ability: 'BLINDAGEM', abilityKind: 'BLINDAGEM' },
  { id: 'card-cosmic-comet', name: 'Cometa Vivo', element: 'Cósmico', rarity: 'Raro', attack: 5, health: 6, energyCost: 3, power: 5, damage: 4, description: 'Cometa Vivo.', ability: 'IMPULSO', abilityKind: 'IMPULSO' },
  { id: 'card-cosmic-solar', name: 'Entidade Solar', element: 'Solar', rarity: 'Raro', attack: 6, health: 6, energyCost: 3, power: 6, damage: 3, description: 'Entidade Solar.', ability: 'DRENO', abilityKind: 'DRENO' },
  { id: 'card-cosmic-lunar', name: 'Entidade Lunar', element: 'Lunar', rarity: 'Épico', attack: 6, health: 6, energyCost: 3, power: 6, damage: 4, description: 'Entidade Lunar.', ability: 'ECO', abilityKind: 'ECO' },
  { id: 'card-cosmic-devourer', name: 'Devorador de Mundos', element: 'Vazio', rarity: 'Épico', attack: 5, health: 6, energyCost: 3, power: 5, damage: 5, description: 'Devorador de Mundos.', ability: 'IMPULSO', abilityKind: 'IMPULSO' },
  { id: 'card-cosmic-voidlord', name: 'Senhor do Vazio', element: 'Vazio', rarity: 'Lendário', attack: 7, health: 6, energyCost: 3, power: 7, damage: 5, description: 'Senhor do Vazio.', ability: 'DRENO', abilityKind: 'DRENO' },
  { id: 'card-cosmic-being', name: 'Ser Cósmico', element: 'Cósmico', rarity: 'Lendário', attack: 7, health: 6, energyCost: 3, power: 7, damage: 4, description: 'Ser Cósmico.', ability: 'ECO', abilityKind: 'ECO' },
  { id: 'card-cosmic-primordial', name: 'Entidade Primordial', element: 'Celestial', rarity: 'Mítico', attack: 6, health: 6, energyCost: 3, power: 6, damage: 6, description: 'Entidade Primordial.', ability: 'ECO', abilityKind: 'ECO' },
  ...
  { id: 'card-hunter-lunar', name: 'Caçador Lunar', element: 'Lunar', rarity: 'Raro', attack: 6, health: 6, energyCost: 3, power: 6, damage: 3, description: 'Caçador Lunar.', ability: 'DRENO', abilityKind: 'DRENO' },
  ...
  { id: 'card-hunter-ghost', name: 'Caçador Fantasma', element: 'Vazio', rarity: 'Épico', attack: 6, health: 6, energyCost: 3, power: 6, damage: 4, description: 'Caçador Fantasma.', ability: 'ECO', abilityKind: 'ECO' },
