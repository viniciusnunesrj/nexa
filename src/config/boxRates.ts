...
export const BOX_CONFIG: Record<BoxType, BoxConfigItem> = {
  ...
  RECRUIT: {
    ...
    category: 'GENERAL',
    image: '/assets/boxes/box-recruit-v1.png',
    accentColor: '#06b6d4',
  ...
  BASIC: {
    ...
    description: 'Caixa inicial de suprimentos com pool aberto em todas as coleções.',
    priceNEX: 300,
    purchasableWithNEX: true,
    category: 'GENERAL',
    image: '/assets/boxes/box-basic-v1.png',
    accentColor: '#10b981',
    glowColor: 'rgba(16, 185, 129, 0.4)',
    badge: 'PADRÃO',
    guarantees: '1 Carta (Comum 55%, Incomum 30%, Raro 12%, Épico 3%)',
  ...
  ADVANCED: {
    ...
    purchasableWithNEX: true,
    category: 'GENERAL',
    image: '/assets/boxes/box-advanced-v1.png',
    accentColor: '#3b82f6',
    glowColor: 'rgba(59, 130, 246, 0.4)',
    badge: 'AVANÇADA',
    guarantees: '1 Carta (Comum 35%, Incomum 30%, Raro 22%, Épico 10%, Lendário 3%)',
  ...
  EPIC: {
    ...
    purchasableWithNEX: true,
    category: 'GENERAL',
    image: '/assets/boxes/box-epic-v1.png',
    accentColor: '#a855f7',
    glowColor: 'rgba(168, 85, 247, 0.5)',
    badge: 'ALTA RARIDADE',
    guarantees: '1 Carta (Comum 10%, Incomum 20%, Raro 30%, Épico 30%, Lendário 9%, Mítico 1%)',
  ...
  LEGENDARY: {
    ...
    purchasableWithNEX: true,
    category: 'GENERAL',
    image: '/assets/boxes/box-legendary-v1.png',
    accentColor: '#f59e0b',
    glowColor: 'rgba(245, 158, 11, 0.6)',
    badge: 'SUPREMA',
    guarantees: '1 Carta (Incomum 5%, Raro 15%, Épico 35%, Lendário 40%, Mítico 5%)',
    possibleRarities: ['Comum', 'Incomum', 'Raro', 'Épico', 'Lendário', 'Mítico'],
    rarityWeights: {
      Comum: 0,
      Incomum: 5,
  ...
  GUARDIANS: {
    ...
    image: '/assets/boxes/box-guardians-v1.png',
    accentColor: '#06b6d4',
    glowColor: 'rgba(6, 182, 212, 0.5)',
    badge: '4 GUARDIÕES',
    guarantees: '1 Carta (Incomum 45%, Raro 30%, Épico 20%, Lendário 5%)',
  ...
  COLLECTION_DRAGONS: {
    ...
    image: '/assets/boxes/box-dragons-v1.png',
    accentColor: '#ef4444',
    glowColor: 'rgba(239, 68, 68, 0.5)',
    badge: 'DRAGÕES',
    guarantees: '1 Carta (Incomum 30%, Raro 35%, Épico 25%, Lendário 9%, Mítico 1%)',
  ...
  COLLECTION_KNIGHTS: {
    ...
    image: '/assets/boxes/box-knights-v1.png',
    accentColor: '#f59e0b',
    glowColor: 'rgba(245, 158, 11, 0.5)',
    badge: 'CAVALEIROS',
    guarantees: '1 Carta (Comum 25%, Incomum 30%, Raro 25%, Épico 14%, Lendário 5%, Mítico 1%)',
    possibleRarities: ['Comum', 'Incomum', 'Raro', 'Épico', 'Lendário', 'Mítico'],
    rarityWeights: {
      Comum: 25,
      Incomum: 30,
  ...
  COLLECTION_ABYSS: {
    ...
    category: 'COLLECTION',
    collectionId: 'abyss',
    image: '/assets/boxes/box-abyss-v1.png',
    accentColor: '#8b5cf6',
  ...
  COLLECTION_MAGES: {
    ...
    category: 'COLLECTION',
    collectionId: 'mages',
    image: '/assets/boxes/box-mages-v1.png',
    accentColor: '#ec4899',
    glowColor: 'rgba(236, 72, 153, 0.5)',
    badge: 'MAGOS',
    guarantees: '1 Carta (Comum 35%, Incomum 30%, Raro 25%, Épico 8%, Lendário 2%)',
    possibleRarities: ['Comum', 'Incomum', 'Raro', 'Épico', 'Lendário'],
    rarityWeights: {
      Comum: 35,
      Incomum: 30,
  ...
  COLLECTION_GODS: {
    ...
    category: 'COLLECTION',
    collectionId: 'gods',
    image: '/assets/boxes/box-gods-v1.png',
    accentColor: '#eab308',
    glowColor: 'rgba(234, 179, 8, 0.5)',
    badge: 'DIVINA',
    guarantees: '1 Carta (Raro 35%, Épico 45%, Lendário 19%, Mítico 1%)',
  ...
  COLLECTION_COSMIC: {
    ...
    category: 'COLLECTION',
    collectionId: 'cosmic',
    image: '/assets/boxes/box-cosmic-v1.png',
    accentColor: '#6366f1',
    glowColor: 'rgba(99, 102, 241, 0.5)',
    badge: 'CÓSMICA',
    guarantees: '1 Carta (Incomum 20%, Raro 35%, Épico 30%, Lendário 14%, Mítico 1%)',
    possibleRarities: ['Incomum', 'Raro', 'Épico', 'Lendário', 'Mítico'],
    rarityWeights: {
      Comum: 0,
      Incomum: 20,
  ...
  COLLECTION_HUNTERS: {
    ...
    image: '/assets/boxes/box-hunters-v1.png',
    accentColor: '#14b8a6',
