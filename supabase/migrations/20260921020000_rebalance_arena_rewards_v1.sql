-- NEXA - Rebalanceamento de recompensas da Arena V1
-- Preserva integralmente combate e matchmaking adaptativo; altera apenas XP/NEX/NXA.
...
BEGIN
  ...
  v_reward:=public.apply_battle_reward_for_run(v_run_id,v_user_id,v_outcome,CASE v_outcome WHEN 'VICTORY' THEN 100 WHEN 'DEFEAT' THEN 30 ELSE 50 END,CASE v_outcome WHEN 'VICTORY' THEN 30 WHEN 'DEFEAT' THEN 8 ELSE 12 END,CASE WHEN v_outcome='VICTORY' THEN 2 ELSE 0 END);
