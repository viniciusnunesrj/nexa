...
const definitions: CardDefinition[] = [
  ...
  ['card-abyss-guardian', 'Guardião do Abismo', 'Lendário', 'TANK', 17, 4, 5, 1, 5, 'PROTECAO'],
  ['card-dragon-red', 'Dragão Rubro', 'Incomum', 'ASSAULT', 8, 7, 1, 3, 2, 'SOBRECARGA'],
  ['card-dragon-frost', 'Dragão Glacial', 'Raro', 'TANK', 16, 4, 4, 1, 4, 'BARREIRA'],
  ...
  ['card-dragon-astral', 'Dragão Astral', 'Épico', 'SPEED', 11, 5, 2, 5, 4, 'IMPULSO'],
  ['card-dragon-volcanic', 'Dragão Vulcânico', 'Lendário', 'TANK', 17, 5, 5, 1, 5, 'SOBRECARGA'],
  ['card-dragon-celestial', 'Dragão Celestial', 'Mítico', 'BALANCED', 12, 5, 3, 4, 4, 'RECARGA'],
  ...
  ['card-knight-imperial', 'Cavaleiro Imperial', 'Lendário', 'TANK', 16, 5, 5, 2, 4, 'PROTECAO'],
  ['card-knight-celestial', 'Cavaleiro Celestial', 'Mítico', 'BALANCED', 14, 6, 4, 4, 5, 'BARREIRA'],
  ...
  ['card-abyss-leviathan', 'Leviatã', 'Épico', 'TANK', 17, 4, 5, 1, 4, 'BARREIRA'],
  ['card-abyss-hydra', 'Hidra Negra', 'Lendário', 'TANK', 17, 4, 5, 1, 5, 'REPARO'],
  ['card-abyss-king', 'Rei do Abismo', 'Mítico', 'BALANCED', 15, 6, 4, 3, 5, 'REPARO'],
  ...
  ['card-mage-archmage', 'Arquimago', 'Lendário', 'SUPPORT', 13, 4, 3, 5, 4, 'RECARGA'],
  ['card-god-war', 'Deus da Guerra', 'Raro', 'ASSAULT', 8, 8, 1, 3, 3, 'SOBRECARGA'],
  ['card-god-moon', 'Deusa da Lua', 'Raro', 'SPEED', 9, 4, 2, 5, 2, 'IMPULSO'],
  ['card-god-thunder', 'Deus do Trovão', 'Épico', 'ASSAULT', 10, 8, 1, 3, 4, 'SOBRECARGA'],
  ['card-god-sea', 'Deus do Mar', 'Épico', 'TANK', 17, 4, 5, 1, 4, 'PROTECAO'],
  ['card-god-death', 'Deus da Morte', 'Épico', 'ASSAULT', 9, 8, 1, 3, 4, 'MARCA'],
  ['card-god-light', 'Deusa da Luz', 'Lendário', 'SUPPORT', 13, 3, 4, 5, 4, 'PROTECAO'],
  ['card-god-chaos', 'Deus do Caos', 'Lendário', 'ASSAULT', 11, 8, 1, 3, 5, 'SOBRECARGA'],
  ['card-god-supreme', 'Deus Supremo', 'Mítico', 'SUPPORT', 13, 4, 3, 4, 4, 'RECARGA'],
  ['card-cosmic-guardian', 'Guardião Estelar', 'Incomum', 'TANK', 14, 4, 4, 2, 3, 'ESCUDO'],
  ['card-cosmic-comet', 'Cometa Vivo', 'Raro', 'SPEED', 8, 4, 1, 5, 1, 'IMPULSO'],
  ...
  ['card-cosmic-devourer', 'Devorador de Mundos', 'Épico', 'ASSAULT', 11, 8, 1, 2, 4, 'RUPTURA'],
  ['card-cosmic-voidlord', 'Senhor do Vazio', 'Lendário', 'ASSAULT', 10, 8, 1, 3, 4, 'MARCA'],
  ['card-cosmic-being', 'Ser Cósmico', 'Lendário', 'BALANCED', 14, 6, 3, 3, 5, 'BARREIRA'],
  ['card-cosmic-primordial', 'Entidade Primordial', 'Mítico', 'TANK', 17, 4, 5, 1, 5, 'REPARO'],
  ['card-hunter-novice', 'Caçador Novato', 'Comum', 'SPEED', 8, 4, 1, 5, 1, 'MARCA'],
  ['card-hunter-shadow', 'Caçador Sombrio', 'Comum', 'SPEED', 8, 4, 1, 5, 1, 'MARCA'],
  ...
  ['card-hunter-master', 'Mestre Caçador', 'Lendário', 'SPEED', 11, 6, 2, 5, 4, 'MARCA'],
];
